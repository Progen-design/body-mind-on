...
import { createEvent } from '../../lib/googleCalendar.js';
import { sendTrainingInvitationEmail } from '../../lib/mail.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!accessToken || expiresAt < now + 60 * 1000) {
      const { refreshAccessToken } = await import('../../lib/googleCalendar.js');
