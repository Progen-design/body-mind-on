...
import { ensureInitialPlanTask } from '../lib/ensureInitialPlanTask.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Oprava historicky poškozeného plan_html: dřívější verze ukládala odeslaný
    // e-mailový dokument zpět do plan_html → parsePlanHtml v profilu pak nenašel
