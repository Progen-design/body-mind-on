...
Sekce <h3>Trénink</h3> pak obsahuje jen krátké obecné zásady: progrese, bezpečnost (dýchání, necvičit přes bolest), zapsat trénink v aplikaci. Volitelně 1–2 obrázky <img> z Unsplash.
