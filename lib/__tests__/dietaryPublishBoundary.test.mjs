 ...
 * runUnifiedPlanPipeline, zatímco nouzová větev v pages/api/body-metrics.js
...
test('body-metrics vrací 503 s hasUserId, ne 200 s prázdným slibem', () => {
  const zdroj = readFileSync(join(KOREN, 'pages', 'api', 'body-metrics.js'), 'utf8');
