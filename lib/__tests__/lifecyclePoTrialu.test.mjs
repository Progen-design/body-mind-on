...
test('zítra končí: s kartou (flag zap) → varianta _card, bez karty → původní', () => {
  ...
  assert.deepEqual(eligibleTriggers(sKartou(0.5), { ...VYP, alreadySent: ['trial_welcome', 'trial_day3', 'trial_day5'] }), ['trial_ends_tomorrow_card'], 's kartou vždy varování před platbou');
});
