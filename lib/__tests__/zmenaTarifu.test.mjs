...
function atrapaStripe({ sub = predplatne(), chybaUpdate = null, amountDue = 60000, schedule = null } = {}) {
  ...
  const klient = {
    ...
    subscriptionSchedules: {
      async create(p) {
        ...
        sched = { id: 'sub_sched_1', phases: [{ start_date: TED_S - 10 * DEN, end_date: TED_S + 20 * DEN, items: [{ price: 'price_club' }] }] };
