...
import { SYSTEM_PROMPT_CHATU } from './coachChat.js';
...
Pole content_plan.theme a aspoň jeden prvek posts.copy musí být vyplněny.`,
  ...
  // TED v chatu. Vlastní slug, ne `coach`: jiný úkol (odpovídá na otázku,
  // negeneruje týdenní zprávu), jiný výstup a přísnější pravidlo o datech —
  // smí mluvit jen o tom, co je v kontextu daného uživatele.
  // Text promptu žije v lib/coachChat.js, ať je u pravidel i komentář proč.
  coach_chat: SYSTEM_PROMPT_CHATU,
};

export const CONTEXT_PROFILE_SLUG = {
  trainer: 'trainer_coach',
  coach: 'trainer_coach',
  // Stejný kontext jako kouč: metriky, plán, návyky, historie, sdílená paměť.
  coach_chat: 'trainer_coach',
...
// 10 = prompt TEDa zna `request.dnesni_plan` (9. 9. 2026). Verze se zvedá
// s kazdou zmenou textu promptu, at jde v ai_logs poznat, ktera odpoved
// vznikla podle ktereho zadani.
