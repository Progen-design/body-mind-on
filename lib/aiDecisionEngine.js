...
function buildTriggerState(hasPlan, hasVeryRecentPlan, hint, eventType, hasEverHadPlan = false) {
  return {
    ...
    // které je generateAITasks zamrzlé.
    //
    // Obnovu plánu po expiraci má dělat producent týdenních úloh. Ten zatím
    // neexistuje; dokud nevznikne, je správné chování NEDĚLAT NIC.
