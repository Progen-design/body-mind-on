...
/** Max. úloh za jedno volání cronu / run-scheduler (default 2 kvůli Vercel timeoutu). Na Pro lze zvednout env AI_SCHEDULER_MAX_TASKS_PER_RUN (max 30). */
const MAX_TASKS_PER_RUN = (() => {
  const n = Number.parseInt(process.env.AI_SCHEDULER_MAX_TASKS_PER_RUN || '2', 10);
