...
import { AGE_MIN, AGE_MAX, AGE_MIN_MESSAGE_CS } from './registrationRules.js';
...
export function validateBirthDate(birthDateIso, refDate = new Date()) {
  ...
  if (age != null && age < AGE_MIN) return { valid: false, error: AGE_MIN_MESSAGE_CS };
  if (age == null || age > AGE_MAX) {
