...
import { SPOONACULAR_REGISTRATION_PAYLOAD_KEY } from './spoonacularQuotaGate.js';
  ...
  const inserts = [
    {
      ...
      payload: {
        prompt:
          'Vygeneruj první personalizovaný 7denní plán pro nového uživatele: praktický jednoduchý jídelníček (běžná fitness jídla, ne fine dining), trénink a denní návyky. Jídla se mohou opakovat.',
        ...
        required_modules: ['nutrition', 'training'],
        output_mode: 'nutrition_training',
    ...
    },
    {
      ...
      payload: {
        prompt:
          'Napiš onboarding zprávu pro nového uživatele: praktický první krok k plánu, jeden tip k jídlu, tréninku a návyku. Bez přehnané motivace.',
      },
      status: 'pending',
    },
  ];
