 ...
 * jinak nejbližší následující pondělí.
 *
 * ZÁMĚRNĚ NEPOUŽÍVANÁ — NEZAPOJOVAT. Byla napsaná pro weekly_plan_update,
 * ale rozhodnutí Honzy 7. 9. 2026 (docs/DALSI_KROK.md 9.6) zarovnání na
 * pondělí zamítlo: kotvou plánu je den REGISTRACE, cyklus je
 * `registrace + 7k` — kdo se registroval ve středu, má týden středa–úterý,
 * a je to tak správně. Doběhové přichycení na tu mřížku dělá
 * `computeTargetFrom` v lib/weeklyPlanProducer.js. Funkce tu zůstává jen
 * proto, aby ji někdo nenapsal znovu v domnění, že chybí.
 *
