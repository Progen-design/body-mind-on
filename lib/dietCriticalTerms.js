...
/**
 * Strop podílu energie z uhlohydrátů pro `low_carb`.
 *
 * Na rozdíl od lepku není low_carb vlastnost názvu ani suroviny, ale makro.
 * Katalog to řeší tagem `low_carb` ze Spoonaculáru; START šablony tag nemají,
 * takže se počítá z jejich vlastních maker. 35 % je hranice, pod kterou se
 * vejdou vejce, omeleta, tvaroh, kuře se zeleninou — tedy dost šablon na to,
 * aby pool nezůstal prázdný, a zároveň ne rýže s bramborami.
 */
export const LOW_CARB_MAX_CARB_ENERGY_SHARE = 0.35;
