 ...
 *
 * `maslo` v `DAIRY_TERMS` schválně NENÍ (nikdo si ho tam nepřál a máslo je
 * prakticky bezlaktózové), ale v masce je — až ho tam někdo přidá, rostlinná
 * másla už budou ošetřená.
 */
