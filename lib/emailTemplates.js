...
/** Jídlo s obrázkem Spoonacular (meal.image_url): 80×80, kulatý/zaoblený náhled. */
function wrapMealParagraphsWithThumbnails(html) {
  ...
  <tr>
    <td width="92" valign="top" style="padding:0;width:92px;vertical-align:top;">
      <img src="${safeUrl}" alt="" width="80" height="80" style="display:block;width:80px;height:80px;max-width:80px;border-radius:999px;object-fit:cover;border:2px solid rgba(124,58,237,0.45);box-shadow:0 4px 14px rgba(0,0,0,0.35);" />
    </td>
 ...
 * @param {string} [ctaUrl] – primární CTA (výchozí /profil = celý plán v aplikaci)
 */
                ...
                <tr>
                  <td align="center" style="padding:8px 0;">
                    ...
                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${escapeHtml(planCta)}" style="height:50px;v-text-anchor:middle;width:300px;" arcsize="14%" stroke="f" fillcolor="#7c3aed">
                      <w:anchorlock/>
                      <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:15px;font-weight:bold;">Zobrazit celý plán</center>
                    </v:roundrect>
                    <![endif]-->
                    <a href="${escapeHtml(planCta)}" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:16px 36px;border-radius:999px;color:#ffffff;text-decoration:none;font-weight:700;font-size:15px;font-family:Arial,sans-serif;letter-spacing:0.03em;background:linear-gradient(135deg,#22d3ee 0%,${EMAIL_ACCENT} 45%,#4c1d95 100%);box-shadow:0 6px 24px rgba(124,58,237,0.35);mso-hide:all;">Zobrazit celý plán</a>
                  </td>
                </tr>
              </table>
