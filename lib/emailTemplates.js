...
/** Jídlo s obrázkem Spoonacular: 100×100, border-radius 12px. */
function wrapMealParagraphsWithThumbnails(html) {
  ...
  <tr>
    <td width="108" valign="top" style="padding:0;width:108px;">
      <img src="${safeUrl}" alt="" width="100" height="100" style="display:block;width:100px;height:100px;max-width:100px;border-radius:12px;object-fit:cover;border:1px solid rgba(124,58,237,0.35);" />
    </td>
    <td valign="middle" style="padding:0 0 0 16px;color:${EMAIL_TEXT};font-size:14px;line-height:1.55;font-family:Arial,sans-serif;">${innerClean}</td>
  </tr>
</table>`;
    }
  );
      ...
      if (h4Match) {
        ...
        if (trainingRest) {
          ...
          t = t.replace(
            ...
            `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:20px 0 10px;"><tr><td style="padding:10px 0 6px;border-top:1px solid rgba(124,58,237,0.45);color:${EMAIL_ACCENT};font-weight:800;font-size:12px;letter-spacing:0.14em;text-transform:uppercase;font-family:Arial,sans-serif;">Trénink</td></tr></table>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 18px;background:${EMAIL_CARD};border-radius:16px;border:1px solid rgba(124,58,237,0.25);overflow:hidden;font-family:Arial,sans-serif;" bgcolor="${EMAIL_CARD}">
  ...
  <tr><td style="padding:18px 18px;color:${EMAIL_TEXT};font-size:14px;line-height:1.55;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 8px;"><tr><td style="padding:0 0 8px;border-bottom:2px solid rgba(124,58,237,0.55);color:#ffffff;font-weight:800;font-size:11px;letter-spacing:0.16em;text-transform:uppercase;">Jídelníček</td></tr></table>
    ${dayInner}
  </td></tr>
</table>`;
      }
    ...
    const mealSectionTitle = `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:28px 0 14px;font-family:Arial,sans-serif;"><tr><td style="padding:4px 0 12px;border-bottom:2px solid rgba(124,58,237,0.55);color:#ffffff;font-weight:800;font-size:18px;letter-spacing:-0.03em;">🍽️ Jídelníček</td></tr><tr><td style="padding:8px 0 0;color:#94a3b8;font-size:13px;">Každý den v kartě · obrázky z Spoonacular</td></tr></table>`;
...
export function buildPlanEmailDocument({
  ...
  const planCta = (ctaUrl || `${app}/trener`).replace(/\/$/, '');
...
<body style="margin:0;padding:0;background-color:${EMAIL_BG};color:${EMAIL_TEXT};font-family:Arial,sans-serif;font-size:16px;line-height:1.5;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:${EMAIL_BG};" bgcolor="${EMAIL_BG}">
    <tr>
      <td align="center" style="padding:24px 12px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;margin:0 auto;background-color:${EMAIL_CARD};border-radius:16px;overflow:hidden;border:1px solid rgba(124,58,237,0.35);" bgcolor="${EMAIL_CARD}">
          <tr>
          ...
          <tr>
            <td style="padding:24px 20px 8px;background-color:${EMAIL_CARD};color:${EMAIL_TEXT};" bgcolor="${EMAIL_CARD}">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 8px;background-color:#16162f;border:1px solid rgba(124,58,237,0.25);border-radius:14px;" bgcolor="#16162f">
                <tr>
                  <td style="padding:20px 16px;color:${EMAIL_TEXT};font-size:14px;line-height:1.55;font-family:Arial,sans-serif;">
                    ${safePlanHtml}
                  </td>
                </tr>
              </table>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:22px 0 24px;">
                <tr>
                  <td align="center" style="padding:8px 0;">
                    <!--[if mso]>
                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${escapeHtml(planCta)}" style="height:50px;v-text-anchor:middle;width:300px;" arcsize="14%" stroke="f" fillcolor="#7c3aed">
                      <w:anchorlock/>
                      <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:15px;font-weight:bold;">Otevřít plán v aplikaci</center>
                    </v:roundrect>
                    <![endif]-->
                    <a href="${escapeHtml(planCta)}" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:16px 32px;border-radius:999px;color:#ffffff;text-decoration:none;font-weight:700;font-size:15px;font-family:Arial,sans-serif;letter-spacing:0.02em;background:linear-gradient(135deg,#6d28d9 0%,${EMAIL_ACCENT} 50%,#5b21b6 100%);mso-hide:all;">Otevřít plán v aplikaci</a>
                  </td>
                </tr>
              </table>
