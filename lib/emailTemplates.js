...
function buildEmailSectionHeader({ index, eyebrow, title, subtitle, accent = '#a78bfa' }) {
  ...
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0 16px;font-family:Arial,sans-serif;"><tr>
    <td valign="middle" style="padding:0;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr>
        <td bgcolor="${accent}" width="38" height="38" style="width:38px;height:38px;background-color:${accent};border-radius:12px;text-align:center;line-height:38px;color:#ffffff;font-size:13px;font-weight:900;font-family:Arial,sans-serif;letter-spacing:0.06em;">${indexLabel}</td>
      ...
      ${subtitle ? `<div style="margin:10px 0 0;color:${EMAIL_MUTED};font-size:13px;line-height:1.55;font-family:Arial,sans-serif;">${escapeHtml(subtitle)}</div>` : ''}
    </td>
  </tr></table>`;
}
...
function buildSnapshotCardCombined({ bm, macrosUlBlock, firstName }) {
  ...
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 18px;border-radius:20px;border:1px solid rgba(167,139,250,0.32);overflow:hidden;font-family:Arial,sans-serif;background-color:${EMAIL_CARD};" bgcolor="${EMAIL_CARD}">
    ...
    <tr><td bgcolor="${EMAIL_CARD}" style="padding:20px 20px 8px;background-color:${EMAIL_CARD};">
