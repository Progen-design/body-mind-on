  ...
  if (workoutListRaw) {
    ...
    while ((liMatch = liRe.exec(workoutListRaw)) !== null) {
      ...
      const apiLinks = wgerId
        ? `<div style="margin-top:8px;line-height:1.6;"><a href="https://wger.de/en/exercise/${encodeURIComponent(wgerId)}/view" target="_blank" rel="noopener noreferrer" style="display:inline-block;margin:0 8px 6px 0;padding:5px 9px;border-radius:7px;border:1px solid rgba(124,58,237,0.45);color:#c4b5fd;text-decoration:none;font-size:11px;font-weight:700;font-family:Arial,sans-serif;">Detail cviku</a><span style="display:inline-block;width:8px;font-size:1px;">&nbsp;</span><a href="https://wger.de/api/v2/exerciseimage/?exercise=${encodeURIComponent(wgerId)}" target="_blank" rel="noopener noreferrer" style="display:inline-block;margin:0 8px 6px 0;padding:5px 9px;border-radius:7px;border:1px solid rgba(59,130,246,0.45);color:#93c5fd;text-decoration:none;font-size:11px;font-weight:700;font-family:Arial,sans-serif;">Média (API)</a><span style="display:inline-block;width:8px;font-size:1px;">&nbsp;</span><a href="https://wger.de/api/v2/video/?exercise=${encodeURIComponent(wgerId)}" target="_blank" rel="noopener noreferrer" style="display:inline-block;margin:0 0 6px 0;padding:5px 9px;border-radius:7px;border:1px solid rgba(16,185,129,0.45);color:#86efac;text-decoration:none;font-size:11px;font-weight:700;font-family:Arial,sans-serif;">Video (API)</a></div>`
        : '';
      cards.push(
