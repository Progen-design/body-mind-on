...
export const CANONICAL_EXERCISES = {
  ...
  // Jednoručkové varianty barbellových cviků pro "doma s vybavením" — vlastní
  // canonical_key, protože equipment_class (a tedy štítek v „Nářadí“) se v
  // exercise_asset_registry váže na canonical_key, ne na search_term/name_cs.
  // Sdílet klíč s barbellovou verzí by dál hlásilo "velká činka" i s jednoručkami.
  dumbbell_bench_press: {
    canonical_key: 'dumbbell_bench_press',
    display_name_cs: 'Tlaky s jednoručkami na lavici',
    wger_search_name: 'dumbbell bench press',
    body_part: 'chest',
    target: 'pectorals',
    equipment: 'dumbbell',
  },
  dumbbell_row: {
    canonical_key: 'dumbbell_row',
    display_name_cs: 'Přítahy s jednoručkou',
    wger_search_name: 'dumbbell row',
    body_part: 'back',
    target: 'upper back',
    equipment: 'dumbbell',
  },
  dumbbell_romanian_deadlift: {
    canonical_key: 'dumbbell_romanian_deadlift',
    display_name_cs: 'Rumunský mrtvý tah s jednoručkami',
    wger_search_name: 'dumbbell romanian deadlift',
    body_part: 'upper legs',
    target: 'hamstrings',
    equipment: 'dumbbell',
  },
  // overhead_press NEMÁ jednoručkovou variantu tady záměrně: produkční
  // exercise_asset_registry mu equipment_class dnes hlásí 'dumbbell', ne
  // 'barbell' jako tahle statická mapa (zjištěno 30. 8. 2026) — UI odvozuje
  // "Nářadí" z registry, takže žádnou lež nehlásí. Vlastní klíč by jen
  // fragmentoval identitu cviku (progrese/dedup) bez efektu na UI a ztratil
  // by potvrzené médium. Pokud se registry někdy opraví na 'barbell', je
  // potřeba se vrátit sem.
};
...
const CZECH_LABEL_MAP = [
  // Jednoručkové varianty MUSÍ být před generickými frázemi níž (např. "bench
  // press", "pritahy", "tlaky", "shoulder press") — jinak by je ty kratší
  // fragmenty pohltily dřív a normalizovaný text by nikdy nedošel sem.
  ['dumbbell bench press', 'dumbbell_bench_press'],
  ['tlaky s jednoruckami na lavici', 'dumbbell_bench_press'],
  ['dumbbell row', 'dumbbell_row'],
  ['pritahy s jednoruckou', 'dumbbell_row'],
  ['dumbbell romanian deadlift', 'dumbbell_romanian_deadlift'],
  ['rumunsky mrtvy tah s jednoruckami', 'dumbbell_romanian_deadlift'],
  ['superman', 'superman'],
