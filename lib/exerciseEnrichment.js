...
} from './exerciseCanonicalMap.js';
import { resolveExercise as wgerResolve, resolveExerciseById } from './services/wgerService.js';
import {
...
async function setRegistryEntry(canonicalKey, entry) {
  ...
  if (!merged.gif_url || !isTrustedExerciseMediaUrl(merged.gif_url)) return;
  try {
