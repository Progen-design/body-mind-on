...
/**
 * Vrátí { from, until } pro příští týden (pondělí–neděle).
 */
...
function buildUserPrompt(bm, pinnedMeals = [], targetStartDate = null) {
...
async function generatePlan(params = {}) {
  ...
  const userPrompt = buildUserPrompt(bm, pinnedMeals);
...
export { generatePlan, generatePlanForEmail, generatePlanAndSendFromParams, getNextWeekRange };
