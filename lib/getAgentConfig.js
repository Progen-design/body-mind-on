...
function buildFallback(agentSlug = 'trainer', forProduction = false) {
  ...
  const fallbackPresets = {
    trainer: {
      model: 'gpt-4.1',
      system_prompt: 'Jsi Body & Mind ON – hlavní autorita pro jídelníček a trénink. Generuješ pouze reálný plán. Piš česky, vracej pouze platný JSON (ok, metrics, html).',
    },
    coach: {
      model: 'gpt-4.1-mini',
