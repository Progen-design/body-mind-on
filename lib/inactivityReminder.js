...
import { vokativ, prvniSlovo } from './vokativ.js';
...
/**
 * PÁTÝ PÁD, NEBO RADŠI NIC — sdílený `lib/vokativ.js` (stejný jako pozdrav
 * v appce). Nejisté jméno dá `null` a e-mail začíná samotným „Ahoj,“.
 *
