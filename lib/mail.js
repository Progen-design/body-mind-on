...
import { escapeHtml, sanitizePlanHtml, formatPlanHtmlForEmail, buildPlanEmailDocument } from './emailTemplates';
...
export async function sendPlanEmail(email, planHtml, options = {}) {
  try {
    ...
    const ctaUrl = (options.ctaUrl || `${appBaseUrl}/trener`).replace(/\/$/, '');
