    ...
    for (const block of dayBlocks) {
      ...
      if (h4Match) {
        ...
        let content = dayContent
          ...
          .replace(/<p[^>]*>\s*<b>\s*Breakfast\s*:?\s*<\/b>/gi, '<p style="margin:0 0 10px;padding:8px 0;border-bottom:1px solid rgba(139,92,255,0.2);color:#d4d4d8;font-size:14px;"><span style="color:#a78bfa;">🌅 Snídaně:</span> ')
          .replace(/<p[^>]*>\s*<b>\s*Lunch\s*:?\s*<\/b>/gi, '<p style="margin:0 0 10px;padding:8px 0;border-bottom:1px solid rgba(139,92,255,0.2);color:#d4d4d8;font-size:14px;"><span style="color:#a78bfa;">☀️ Oběd:</span> ')
          .replace(/<p[^>]*>\s*<b>\s*Dinner\s*:?\s*<\/b>/gi, '<p style="margin:0 0 10px;padding:8px 0;color:#d4d4d8;font-size:14px;"><span style="color:#a78bfa;">🌙 Večeře:</span> ')
          .replace(/<p[^>]*>\s*<b>\s*Snack\s*:?\s*<\/b>/gi, '<p style="margin:0 0 10px;padding:8px 0;color:#d4d4d8;font-size:14px;"><span style="color:#a78bfa;">🍎 Svačina:</span> ')
