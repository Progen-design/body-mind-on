...
/**
 * Nápis jídla v plánu (HTML, e-mail, UI): u ověřeného Spoonacular receptu vždy `recipe.title` z API;
 * jinak text z GPT / plánovače / HTML (GPT jen doplňuje strukturu, čísla a název u ověřeného jdou ze Spoonacular).
