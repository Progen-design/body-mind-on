...
/** Query-type → forbidden image alt. Prevents yogurt/salad/breakfast from matching burger. */
const PEXELS_QUERY_MISMATCH = [
  { queryHints: ['jogurt', 'yogurt', 'tvaroh', 'cottage', 'ovesna', 'oatmeal', 'snidane', 'breakfast', 'müsli', 'muesli'], forbiddenAlt: ['burger', 'hamburger', 'pizza', 'fries', 'sandwich', 'hotdog'] },
  { queryHints: ['salat', 'salad'], forbiddenAlt: ['burger', 'hamburger', 'pizza'] },
