 ...
 * Nižší práh = vyšší úspěšnost resolve jídel; obrázek „exact“ stále jen při image z API.
 */
export const MEAL_CONFIDENCE_THRESHOLD = 0.35;
...
export async function searchMealMetadata(mealName, mealKey = null, opts = {}) {
  ...
  /** Recept považujeme za sladěný se dotazem při dostatečném skóre — nezávisle na obrázku. */
  const scoreAccepted = best.scoreFinal >= CONFIDENCE_THRESHOLD;
  /** Obrázek jen pokud je skóre OK a API vrátil image (žádné „uhodnuté“ fotky). */
