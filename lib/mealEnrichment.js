...
export async function searchMealMetadata(mealName, mealKey = null, opts = {}) {
  ...
  if (!best && allEvaluations.length) {
    // Když je dedup aktivní, NIKDY se nevracejme k duplikátu jen proto, že shortlist neměl alternativu —
    // jinak by „dedupe-refetch" vracel ten samý recept a celý týden by měl 7× to samé.
    if (!excludeActive) {
