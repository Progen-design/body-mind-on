...

{
  ...
  assert(roundCookableAmount(0.575, 'ks', 'okurka') === 1, `okurka ${roundCookableAmount(0.575, 'ks', 'okurka')}`);
...

{
  ...
  assert(scaled.portion_multiplier >= 0.85 && scaled.portion_multiplier <= 1.2, `mult ${scaled.portion_multiplier}`);
