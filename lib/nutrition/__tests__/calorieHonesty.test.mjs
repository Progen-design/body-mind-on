...
assert(MAX_MEALS_PER_DAY_CAP === 7, 'meal cap');
assert(maxExtraMealsForTarget(3500, 5) <= 3, '5 skeleton high TDEE extras');
assert(maxExtraMealsForTarget(2800, 5) <= 2, 'extras for mid target');
assert(maxExtraMealsForTarget(3500, 5) + 5 <= 8, 'total under high cap');
