...

{
  ...
  assert(summary.achieved_kcal === meals.reduce((s, m) => s + m.kcal, 0), 'achieved matches sum');
  assert(meals.every((m) => (Number(m.portion_multiplier) || 1) <= HONEST_MAX_SCALE), 'no meal over 1.15');
