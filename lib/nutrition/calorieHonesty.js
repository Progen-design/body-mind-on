...
/** Soft UX cap — prefer denser meals over 8+ eating occasions. */
export const MAX_MEALS_PER_DAY_CAP = 6;
/** High TDEE (≥3400) may use one extra occasion. */
export const MAX_MEALS_PER_DAY_CAP_HIGH = 7;
