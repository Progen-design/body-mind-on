...
/**
 * Deterministický denní cíl s mírným rozptylem (±3–6 %) v rámci ±15 % tolerance.
 */
 ...
 */
export function balanceDayMealsToCalorieTarget(dayMeals, dailyTarget, tolerance = 0.15) {
  ...
  const goalSum = sum < minSum ? minSum : sum > maxSum ? maxSum : sum;
