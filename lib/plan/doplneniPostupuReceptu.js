 ...
 *
 * 420 z 1104 receptů (8. 9. 2026) neprojde `posudPostup()` z kvalitaPostupu.js.
 * `coach_seed_v1` je zvláštní případ: 153 receptů je ve skutečnosti 65 METOD
 * s doplněnou gramáží pro porční varianty (" — porce 200/300" apod.) — model
 * se proto volá jednou na SKUPINU, ne jednou na recept, a gramáž se do
 * vygenerované metody dosadí čistou funkcí `vlozGramaze()`.
 *
