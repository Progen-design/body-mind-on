...
// Re-export drží dosavadní volající (api/profile.js, weeklyPlanProducer)
...
export async function canRunPlanTask(userId, agentSlug, taskType) {
  ...
  // Trial (i ON CLUB po upgradu během trialu) se řídí stejně jako START trial.
  if (tier === 'START' || membership.status === 'trial') {
