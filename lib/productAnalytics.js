 ...
 */
import { getSafeAttribution, readAttributionFromStorage } from './productAttribution.js';
...
/**
 * Fire-and-forget for page unload (abandon). Uses sendBeacon when available.
 * @param {string} eventName
 * @param {Record<string, unknown>} [properties]
 * @param {{ pagePath?: string, source?: string }} [options]
 * @returns {boolean}
 */
export function trackProductEventBeacon(eventName, properties = {}, options = {}) {
