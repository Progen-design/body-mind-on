...
export const PRODUCT_EVENT_NAMES = Object.freeze([
  ...
  'habit_completed',
  'meal_replaced',
  'workout_change_opened',
  'workout_change_preferences_selected',
  'workout_alternative_generated',
  'workout_alternative_confirmed',
  'workout_alternative_regenerated',
  'workout_original_restored',
  'workout_change_failed',
