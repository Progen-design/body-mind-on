 ...
 */
export const NEON_TLACITKO = 'inline-flex items-center justify-center gap-2 rounded-2xl '
...
export const ZALOZKA = 'relative flex items-center gap-2 rounded-xl px-3.5 py-2 '
  + 'text-xs sm:text-sm font-semibold transition-all duration-200 cursor-pointer '
  + 'bg-transparent border border-transparent '
  + 'text-neutral-400 hover:text-neutral-200 hover:bg-neutral-800/50';

export const ZALOZKA_AKTIVNI = 'relative flex items-center gap-2 rounded-xl px-3.5 py-2 '
  + 'text-xs sm:text-sm font-semibold transition-all duration-200 cursor-pointer '
  + 'text-white bg-gradient-to-r from-[#082c33]/80 to-[#07271d]/80 '
...
export const TLACITKO_IKONA = 'inline-flex items-center justify-center shrink-0 '
  + 'h-9 w-9 rounded-full bg-transparent border border-[#00f2fe]/40 text-[#e0f2fe] '
