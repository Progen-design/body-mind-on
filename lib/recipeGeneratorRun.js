...
async function zapisRecept(r, polozka, client) {
  ...
  // vrátil postup pod laťkou (míň než 4 kroky, kratší než 200 znaků, vata
  // typu "Připrav X" bez obsahu…), se nezapíše. Bez tohohle dluh z 38 %
  // receptů pod laťkou dál roste s každým dalším generováním.
