...
Generuj praktický jídelníček pro obyčejného člověka. Nepiš food blog. Nepiš fine dining.
Preferuj běžná, rychlá a levná jídla z běžných surovin (kuře, vejce, rýže, brambory, těstoviny, tvaroh, jogurt, šunka, zelenina).
Jídla se MOHOU opakovat — jednoduchost a dodržitelnost jsou důležitější než pestrost.
Vysoké kalorie řeš větší porcí jednoduchých jídel, ne složitějšími recepty.
Snídaně/svačina: max 5 surovin, 5–15 min. Oběd/večeře: max 6–8 surovin, 20–30 min.
Postup max 3–5 kroků, jednoduché věty. Vyhni se: frittata, lasagne, krabí, pesto, salsa, kaviár, fenykl, redukce, glazura, vrstvy, mexická mísa jako default.`;
