...
export async function fetchCatalogCandidates(params) {
  ...
  // Okno je násobně širší než dřív, takže se musí načíst víc řádků — jinak by
  // limit uřízl kandidáty ještě před tvrdými filtry a zúžení by se vrátilo
  // zadními dveřmi. Katalog má na slot řádově 120–160 aktivních receptů.
  const fetchLimit = Math.max(limit * 6, 150);
  ...
  function passesPostScale(r) {
    ...
    return naservirovano >= minKcal - 0.5 && naservirovano <= maxKcal + 0.5;
  }
