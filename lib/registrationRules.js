 ...
 * - Stejná validace: výška 100–250 cm, váha 30–300 kg, věk (fallback) 13–90, heslo min. 6 znaků
...
export function validateAge(value) {
  ...
  if (n < AGE_MIN || n > AGE_MAX) return { valid: false, error: 'Věk musí být mezi 13 a 90.' };
  return { valid: true };
}
