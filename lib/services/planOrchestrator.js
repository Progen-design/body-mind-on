...
import { searchMealMetadata, MEAL_CONFIDENCE_THRESHOLD } from '../mealEnrichment';
...
/** Tvrdý strop Spoonacular volání na jeden plán (unikátní dotazy + fallbacky). Zvýšeno kvůli 21 jídlům. */
const MAX_SPOONACULAR_REQUESTS_PER_PLAN = 80;

/** Když recept není ověřený, zobraz AI dotaz (angl.) nebo název z meta — ne jen „Jídlo (neověřeno)“. */
