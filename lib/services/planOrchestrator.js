...
import { filterWorkoutPlanForTrainingEnvironment, parseTrainingEnvironment, TRAINING_ENVIRONMENT_LABELS } from '../trainingEnvironment.js';
...
export async function generateStructuredPlan(bodyMetrics, opts = {}) {
  ...
  const trainingEnvLabel = TRAINING_ENVIRONMENT_LABELS[trainingEnv] || TRAINING_ENVIRONMENT_LABELS.gym;
