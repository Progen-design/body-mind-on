...
export async function generateStructuredPlan(bodyMetrics, opts = {}) {
  ...
  if (useOpenAI) {
    ...
    if (opts.simpleStartMode === true) {
      const startMealRule =
        'START PLÁN: Nepoužívej burrito, kari, frittata, lasagne, food-blog názvy. Používej pouze běžná jídla (tvaroh/vločky, vejce/pečivo, kuře/rýže, těstoviny/tuňák). Pokud si nejsi jistý, zvol kuře s rýží nebo tvaroh s banánem.';
      bmForOpenAI = {
        ...bodyMetrics,
