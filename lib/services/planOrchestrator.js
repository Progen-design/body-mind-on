...
- Tréninkové dny: přesně ${bodyMetrics?.weekly_sessions_user ?? bodyMetrics?.weekly_sessions ?? workouts} dní v týdnu s cvičením; ostatní dny = pouze rest (canonical_key: "rest").
- Vybavení: ${equipment}
