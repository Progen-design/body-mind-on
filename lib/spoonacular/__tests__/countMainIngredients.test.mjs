...

{
  ...
  assert(getMainIngredientLimit('snidane') === 4, 'snidane limit 4');
  ...
  assert(!gate.pass && gate.reason === 'too_complex', `snidane 5 mains rejected: ${gate.reason}`);
  console.log('OK snidane rejects 5+ main ingredients');
}
