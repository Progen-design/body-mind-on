...
// z 6 na 10 (31. 7. 2026), časy zůstávají.
export const MEAL_SIMPLICITY_RULES = Object.freeze({
  snidane: { maxMainIngredients: 10, maxReadyTime: 15, maxSteps: 12 },
  svacina: { maxMainIngredients: 10, maxReadyTime: 10, maxSteps: 99 },
  obed: { maxMainIngredients: 10, maxReadyTime: 20, maxSteps: 8 },
  vecere: { maxMainIngredients: 10, maxReadyTime: 20, maxSteps: 6 },
});
