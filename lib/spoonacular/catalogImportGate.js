...
export const MEAL_SIMPLICITY_RULES = Object.freeze({
  snidane: { maxMainIngredients: 6, maxReadyTime: 15, maxSteps: 12 },
  svacina: { maxMainIngredients: 6, maxReadyTime: 10, maxSteps: 99 },
  obed: { maxMainIngredients: 6, maxReadyTime: 20, maxSteps: 8 },
  vecere: { maxMainIngredients: 6, maxReadyTime: 20, maxSteps: 6 },
});
