...
import { buildDietaryPublishRules, checkCandidateAgainstDiet } from './dietaryRules.js';
...
export function resolveSimpleStartLocalSlot(slotMeal, slotTarget, slotSalt = 0, bodyMetrics = null) {
  ...
  if (libraryMeal && !mealContainsExcludedFood(libraryMeal, exclusions)) {
    ...
    const targetMult = clampedPortionMultiplier(baseKcal, slotTarget, { simpleStartMode: true });
