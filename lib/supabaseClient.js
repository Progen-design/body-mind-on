...
const stubAuth = {
  ...
  signInWithPassword: () => Promise.resolve({ data: null, error: { message: 'Supabase není nakonfigurován. Nastav NEXT_PUBLIC_SUPABASE_URL a NEXT_PUBLIC_SUPABASE_ANON_KEY v Vercel.' } }),
