...
/**
 * JEN PRO TESTY: podstrčí atrapu klienta, aby šel celý endpoint projít bez
 * Supabase (lib/__tests__/komunitaPristup.test.mjs). V aplikaci se nevolá.
 * @param {object|null} klient
 */
export function nastavSupabaseServerProTesty(klient) {
  _client = klient;
}
