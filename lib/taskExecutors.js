...
import { sendPlanEmail, persistSentPlanEmailHtml } from './mail';
    ...
    if (planAlreadyEmailed) {
      ...
      if (!emailValid.ok) {
        ...
        if (!claimedSend) {
          ...
          if (emailSent && sendResult?.sent_html && planId) {
            await persistSentPlanEmailHtml(planId, sendResult.sent_html);
          }
