...
export const MEAL_TRAINING_COHERENCE = {
  ...
  /**
   * Počet tréninkových dnů vs. profil — vypnuto: LLM plán dle cíle nemusí sedět s weekly_sessions.
   * Strojová kontrola v structuredPlanValidators: jen varování + hard fail při více než 7 dnech s cviky.
   */
  workoutDaysMustMatchProfile: false,
