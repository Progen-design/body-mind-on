...
// Jediná implementace BMI je v lib/bmi.js — lib/telesneSlozeni.js na ni
// potřebuje sáhnout taky, ale nesmí kvůli tomu naimportovat supabaseServer.js
// z tohohle souboru. `import` + `export` (ne `export … from`) proto, že se
// calculateBmi() dál v tomhle souboru i volá (níž) — re-export bez importu
// by tu lokální vazbu nevytvořil.
