...
/** Rotující bloky – full body / dolní+core / horní / síla+core (domácí / vlastní váha) */
const HOME_SESSION_TEMPLATES = [
  [
...
/** Rotující bloky pro posilovnu — stroje a činky, žádné domácí kliky / prkna. */
const GYM_SESSION_TEMPLATES = [
  [
    { canonical_key: 'leg_press', search_term: 'leg press', name_cs: 'Leg press', sets: 4, reps: '12' },
    { canonical_key: 'bench_press', search_term: 'bench press', name_cs: 'Bench press', sets: 4, reps: '10' },
  ...
  [
    ...
    { canonical_key: 'romanian_deadlift', search_term: 'romanian deadlift', name_cs: 'Rumunský mrtvý tah', sets: 3, reps: '10' },
    { canonical_key: 'bench_press', search_term: 'incline bench press', name_cs: 'Tlak na šikmé lavici', sets: 3, reps: '10' },
  ...
  [
    { canonical_key: 'bench_press', search_term: 'bench press', name_cs: 'Bench press', sets: 4, reps: '8-10' },
    { canonical_key: 'bent_over_row', search_term: 'bent over row', name_cs: 'Přítahy v předklonu', sets: 3, reps: '10' },
    { canonical_key: 'overhead_press', search_term: 'shoulder press', name_cs: 'Tlaky na ramena', sets: 3, reps: '10' },
    { canonical_key: 'bicep_curl', search_term: 'bicep curl', name_cs: 'Bicepsový zdvih', sets: 3, reps: '12' },
    { canonical_key: 'tricep_extension', search_term: 'tricep extension', name_cs: 'Triceps', sets: 3, reps: '12' },
  ...
  [
    { canonical_key: 'deadlift', search_term: 'deadlift', name_cs: 'Mrtvý tah', sets: 3, reps: '8' },
    { canonical_key: 'leg_press', search_term: 'leg press', name_cs: 'Leg press', sets: 4, reps: '12' },
    { canonical_key: 'pull_up', search_term: 'lat pulldown', name_cs: 'Stahování horní kladky', sets: 3, reps: '10' },
    { canonical_key: 'bench_press', search_term: 'bench press', name_cs: 'Bench press', sets: 3, reps: '10' },
    { canonical_key: 'bent_over_row', search_term: 'cable row', name_cs: 'Přítahy na kladce', sets: 3, reps: '10' },
    { canonical_key: 'tricep_extension', search_term: 'tricep pushdown', name_cs: 'Triceps na kladce', sets: 3, reps: '12' },
  ],
];

function sessionTemplatesForBodyMetrics(bodyMetrics = {}) {
  const env = parseTrainingEnvironment(bodyMetrics);
  return env === 'gym' ? GYM_SESSION_TEMPLATES : HOME_SESSION_TEMPLATES;
}
...
export function enforceWorkoutsPerWeekInPlan(workoutPlan, bodyMetrics = {}) {
  ...
  for (let i = 0; i < slotIndices.length; i++) {
    ...
    if (source) {
      ...
      const templates = sessionTemplatesForBodyMetrics(bodyMetrics);
