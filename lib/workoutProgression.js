...
export const PROGRESSION_BY_EXERCISE = Object.freeze({
  ...
  // docs/DALSI_KROK.md 8.16 — nové klíče v HOME_BW_C/D. Stejné pravidlo jako
  // u ostatní vlastní váhy na opakování výš: nikdo je neváží, progrese jde
  // přes opakování, ne kilogramy.
  bent_knee_hip_raise: { kind: 'bodyweight_reps' },
  crunch_hands_overhead: { kind: 'bodyweight_reps' },
  glute_kickback: { kind: 'bodyweight_reps' },
  calf_raise: { kind: 'bodyweight_reps' },
  single_leg_butt_kick: { kind: 'bodyweight_reps' },
