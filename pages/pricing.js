...
const plans = [
  ...
  { id: 'group', title: 'Skupina', price: '2 490 Kč / měsíc', perks: ['Vše z Individuálního', 'Skupinový trénink', 'Přístup do komunity', 'Q&A s koučem'] },
  { id: 'addon', title: 'Add-on: Osobní lekce', price: '60 min = 1 190 Kč / 90 min = 1 690 Kč', perks: ['Doobjednej kdykoliv', 'Balíčky – sleva', 'Storno do 24 h zdarma'] }
]
...
export default function Pricing() {
  ...
  function choosePlan(planId) {
    // přesměruj na registrační stránku s parametrem
  ...
  return (
    <>
      ...
      <main className="container">
        <h1>Ceník</h1>
        <p>Vyber plán, který ti nejvíc vyhovuje. Add-ony lze dokoupit později.</p>
