#!/usr/bin/env node
/**
 * Aplikuje migraci direct beta join.
 */
...
const MIGRATION_FILE = join(root, 'supabase/migrations/20260713180000_beta_join_without_invite.sql');
...
console.log('Migration applied: 20260713180000_beta_join_without_invite.sql');
