#!/usr/bin/env node
/**
 * Aplikuje migraci workout_replacements.
 */
...
const MIGRATION_FILE = join(root, 'supabase/migrations/20260713200000_workout_replacements.sql');
...
console.log('OK workout_replacements migration applied');
